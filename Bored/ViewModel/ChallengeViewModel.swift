...
class ChallengeViewModel{
   ...
   // func markTodaysChallengeAsCompleted(){
    ...
    Challenge(name: "Morning Coffee ☕️", content: "For this challenge you need to... Enjoy your morning beverage, capture the moment with a photo, and reflect on the calmness it brings to your day.", completed: true, assignedDate: "02"),
    ...
    Challenge(name: "Mindfulness Moment 🧖‍♀️", content: "For this challenge you need to... Practice a quick mindfulness exercise, photograph something that symbolises the present moment, and reflect on the peace it brings", assignedDate: "15"),
    Challenge(name: "Cloud Watching 🌥️", content: "For this challenge you need to... Lie on the grass and watch the clouds, snap a picture of an interesting cloud formation, and reflect on the beauty of the sky.", assignedDate: "16"),
    ...
    Challenge(name: "Travel Memory ✈️", content: "For this challenge you need to... Look through your travel photos and choose one, then reflect on the memories and experiences associated with that place.", assignedDate: "21"),
    Challenge(name: "Garden Snapshot ⛲️", content: "For this challenge you need to... Capture a picture of a beautiful flower or plant, and reflect on the satisfaction of gardening", assignedDate: "22"),
    ...
    Challenge(name: "Favourite Art Piece 🖼️", content: "For this challenge you need to... Spend a few minutes looking at a piece of art you love, photograph it, and reflect on the emotions it evokes.", assignedDate: "27"),
    Challenge(name: "Desk Tidy-Up 🖥️", content: "For this challenge you need to... Quickly organise your workspace, take a photo of the tidy result, and reflect on the impact of a clean and organised environment.", assignedDate: "28"),
