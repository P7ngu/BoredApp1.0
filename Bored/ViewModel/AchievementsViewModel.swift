...
class AchievementsViewModel{
    ...
    var achievements: [Achievement] = [
        ...
        Achievement (name: "5some", content: "Complete 5 challenges",
                     completitionMaxPoints: 5.0, completitionPoints: 2.0, imageName: "trophy3"),
        Achievement (name: "CONGRA7S!", content: "Complete 7 challenges",
                     completitionMaxPoints: 7.0, completitionPoints: 2.0, imageName: "trophy4"),
        Achievement(name: "The best in the game", content: "Complete all the challenges",
                    completitionMaxPoints: 31.0, completitionPoints: 2.0, imageName: "trophy5")
    ]
